...
class SOLUTION:
    ...
    def Create_Body(self):
        ...
        pyrosim.Send_Cube(name = "BackRightLowerArm", pos=[0,-0.125,-0.5], size = [0.25,0.25,1])
        ...
        pyrosim.Send_Cube(name = "BackLeftLowerArm", pos=[0,0.125,-0.5], size = [0.25,0.25,1])
        ...
        pyrosim.Send_Cube(name = "FrontRightLowerArm", pos=[0,-0.125,-0.5], size = [0.25,0.25,1])
